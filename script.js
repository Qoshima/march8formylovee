const config = {
  photos: [
    { src: "assets/photos/photo01.jpg", alt: "Вы вместе, счастливый момент", caption: "Мы сидели в Меге, я уставший, не спавший сидел, а ты сфотала меня. Это было так мило в тот момент, а еще, мы тогда впервые взялись за ручку.", portrait: true },
    { src: "assets/photos/photo02.jpg", alt: "Здесь мы ждали агая после пары по калку. Обнявшись стояли вдвоем возле кабинета.", caption: "Здесь мы ждали агая после пары по калку. Обнявшись, стояли вдвоем возле кабинета.", portrait: true },
    { src: "assets/photos/photo03.jpg", alt: "Улыбка любимой девушки", caption: "Был понедельник, и мы сидели в шекере. Я показывал свою галлерею, а ты смотрела на меня с улыбкой. А дальше, дальше мы пошли в мегу смотреть одежду." },
    { src: "assets/photos/photo04.jpg", alt: "Объятия и нежность", caption: "17 января, день первого поцелуя. Всё та же улыбка на твоем лице. В меге, после золотого яблока на эсклаторе. В тот день я стал твоим в полную меру." },
    { src: "assets/photos/photo05.jpg", alt: "Красивый совместный кадр", caption: "Сидели на дбмс, дурачились. Вместе🫶" },
    { src: "assets/photos/photo06.jpg", alt: "Светлый день вместе", caption: "Также дбмс, хотели сфоткать с сердечком одинаковым. Но получилось еще круче и еще лучше. 🫀" },
    { src: "assets/photos/photo07.jpg", alt: "Смех и радость", caption: "Здесь мы в кино пошли. Честно уже не помню в какое, но было намного интереснее вместе с тобой жаным. Ведь вместе мы счастливыми." },
    { src: "assets/photos/photo08.jpg", alt: "Вечерняя романтика", caption: "День в меге, ты была потрясающей, купила парные брелочки которые я ношу всегда с собой. Ты - моя любовь.❤️" },
    { src: "assets/photos/photo09.jpg", alt: "Незабываемое свидание", caption: "Я качался, и ты подошла, а я без раздумий взял тебя на ручки жаным. Еще физрук так посмотрел на нас тогда. Я хочу нести весь мир у себя на руках, а весь мир для меня это ты моя лапочка🎀", portrait: true },
    { src: "assets/photos/photo10.jpg", alt: "Нежный взгляд", caption: "Первый раз когда ты пришла ко мне домой. Это было так мило. Твоё доверие и чувство безопасности со мной, я ценю и уважаю твои действия и слова.", portrait: true },
    { src: "assets/photos/photo11.jpg", alt: "Ваш особенный момент", caption: "Та самая фотография которую я думаю стоит выложить на страничку. Такая не принужденная, спокойная, легкая. Я очень люблю тебя❤️" },
    { src: "assets/photos/photo12.jpg", alt: "Счастливые воспоминания", caption: "Эти моменты, которые мы разделили, для меня бесценны. Спасибо, что ты есть." }
  ],
  uiText: {
